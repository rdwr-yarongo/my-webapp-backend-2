    ...
    <div class="card">
      <div class="card-header">
        <div>
          ...
          <span>All incoming HTTP headers</span>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-header">
        <div>
          ...
          <span>Headers generated by this application/server</span>
        </div>
      </div>
      <div class="headers-wrap">
        <table class="info-table">
          <?php
            // Capture all response headers set by PHP
            $responseHeaders = headers_list();

            // Add common server headers if not explicitly present
            echo '<tr><td>Status</td><td class="info-value">200 OK</td></tr>';
            ...
            // Some headers are added by Apache and not visible to PHP
            echo '<tr><td>Server</td><td class="info-value">' . htmlspecialchars(getenv('SERVER_SOFTWARE') ?: 'Apache') . '</td></tr>';
          ?>
        </table>
      </div>
    </div>
